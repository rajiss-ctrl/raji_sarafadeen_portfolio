            ...
            <div className="lg:w-1/2 ">
              <div className="flex gap-2 bg-[#191d2b] font-light p-6">
                ...
                <div className="">
                  <p>Phone</p>
                  <p>
                  <Link href="tel:+2347038699659" className='text-[#86a4c4]'>+234-703-8699-659</Link>
                  </p>
                  <p>
                  <Link href="tel:+2348155975040" className='text-[#86a4c4]'>+234-815-5975-040</Link>
                  </p>
              ...
              <div className="flex gap-3 bg-[#191d2b] font-light mt-6 p-6">
                <div className="text-center border border-gray-600 p-6">
                 ...
                 <div className="">
                  <p>Email</p>
                  <p>
                    <Link href="mailto:omosanjos77@gmail.com" className='text-[#86a4c4]'>omosanjos77@gmail.com</Link>
                  </p>
                  <p>
                     <Link href="mailto:omosanjos77@gmail.com" className='text-[#86a4c4]'>hackyraji02@gmail.com</Link>
                  </p>
              ...
              <div className="flex gap-3 bg-[#191d2b] font-light mt-6 p-6">
                 ...
                 <div className="">
                  <p>Address</p>
                  <p className='text-[#86a4c4]'>11 Akapoti Street, Olunlade, Ilorin, Kwara State Nigeria</p>
                </div>
              </div>
            </div>
          </div></div>
